...
class NewProjectNormalizer implements DenormalizerInterface, NormalizerInterface, DenormalizerAwareInterface, NormalizerAwareInterface
{
    ...
    {
        return $type === \Datenkraft\Backbone\Client\OrganizationStructureApi\Generated\Model\NewProject::class;
    }
    public function supportsNormalization(mixed $data, ?string $format = null, array $context = []): bool
    {
        return is_object($data) && get_class($data) === \Datenkraft\Backbone\Client\OrganizationStructureApi\Generated\Model\NewProject::class;
    }
    ...
    {
        return [\Datenkraft\Backbone\Client\OrganizationStructureApi\Generated\Model\NewProject::class => false];
    }
}